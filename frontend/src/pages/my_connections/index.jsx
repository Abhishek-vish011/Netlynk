    ...
    <UserLayout>
          ...
          <DashboardLayout>
             ...
             <div style={{display: "flex", flexDirection: "column", gap: "0.5rem"}}>
              ...
              <h4 style={{background: "white", padding: "1rem"}}>My Requests </h4>

              {authState.connectionRequest.length === 0 && <h2>No Connection Request</h2>}
              ...
              {authState.connectionRequest.length != 0 && authState.connectionRequest.filter((connection)=> connection.status_accepted === null).map((user, index)=>{
               ...
               <h4 style={{background: "white", padding: "1rem"}}>My Networks</h4>
