...
import { createPost, deletePost, getAllCommments, getAllPosts, incrementPostLike, postComment } from '@/config/redux/action/postAction';
...
if(authState.user){
          ...
          <DashboardLayout>
             ...
             <div className={styles.scrollComponent}>
               ...
               <div className={styles.createPostContainer}>
                ...
                <textarea onChange={(e)=> setPostContent(e.target.value)} value={postContent} placeholder={"What's in your mind?"} className={styles.teaxtareaContent} name="" id=""></textarea>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    <path strokeLinecap="round" 
          ...
          d="M6 12 3.269 3.125A59.769 59.769 
             ...
             0 0 1 3.27 20.875L5.999 12Zm0 0h7.5" />
  </svg>
</div>
  ...
  <div className={styles.optionMedia}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" 
            d="m2.25 15.75 5.159-5.159a2.25 
               2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 
               1.409-1.409a2.25 2.25 0 0 1 
               3.182 0l2.909 2.909m-18 
    ...
    <svg xmlns="http://www.w3.org/2000/svg" 
      ...
      <path strokeLinecap="round" strokeLinejoin="round" 
            d="m15.75 10.5 4.72-4.72a.75.75 
               0 0 1 1.28.53v11.38a.75.75 
               0 0 1-1.28.53l-4.72-4.72M4.5 
               18.75h9a2.25 2.25 0 0 0 
               2.25-2.25v-9a2.25 2.25 
               0 0 0-2.25-2.25h-9A2.25 
               2.25 0 0 0 2.25 7.5v9a2.25 
    ...
    <p>Video</p>
                  ...
                  <div className={styles.feedHeader}>
                   ...
                   <div className={styles.feedButtons}>
                    <button className={styles.tabButtons}>Latest</button>
                      ...
                      <div key={post._id} className={styles.singleCard}>
                        <div className={styles.singleCard_profileContainer}>
                          ...
                          <div style={{display: "flex", justifyContent: "space-between"}}>
                              <p style={{fontWeight: "bold"}}>{post.userId.name}</p>
                               {
                                ...
                                <svg style={{height: "1.45rem", color: "brown"}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                              ...
                              <p style={{paddingTop: "0.6rem", fontSize: "13px"}}>{post.body}</p>

                              <div className={styles.singleCard_image}>
                               {post.media !== "" ?   <img src={`${BASE_URL}/${post.media}`} alt="" /> : <></> }
                              </div>
                               <div>
                                <p>like by {post.likes}</p>
                               </div>
                              <div className={styles.optionContainer}>
                                     <div onClick={async()=>{
                                      await dispath(incrementPostLike(post._id))
                                      dispath(getAllPosts())
                                     ...
                                     <div onClick={()=>{
                                      dispath(getAllCommments({post_id: post._id}))
                                     }} className={styles.singleOption_optionContainer}>
                                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                     ...
                                     <div onClick={()=>{
                                      ...
                                      const twitterUrl = `https:twitter.com/intent/tweet?text=${text}&url=${BASE_URL}`
                ...
                dispath(resetPostId())
                  ...
                  <div onClick={(e)=>{
                            ...
                            return (
                              <div className={styles.singleComment} key={comment._id}>
                                <div className={styles.singleComment_profileContainer}>
                                  ...
                                  <div>
                                    <p style={{fontWeight: "bold", font: "1.2rem"}}>{comment.userId.name}</p>
                    ...
                    <div className={styles.postCommentContainer}>
                      <input type="" value={commentText} onChange={(e)=> setCommentText(e.target.value)} placeholder="Commment" />
                      <div onClick={ async ()=>{
                           await dispath(postComment({post_id: postState.postId, body: commentText}))
                           await dispath(getAllCommments({post_id: postState.postId}))
  ...
  return(
   ...
   <UserLayout>
      ...
      <div className={`${styles.spinner} ${styles.glow}`} aria-hidden="true"></div>
